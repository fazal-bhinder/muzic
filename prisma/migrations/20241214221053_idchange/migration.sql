/*
  ...
  - You are about to drop the column `streamerId` on the `Upvote` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "Upvote_userId_streamerId_key";

-- AlterTable
ALTER TABLE "Upvote" DROP COLUMN "streamerId",
